...
import 'package:gofid_mobile_fix/Pages/Member/HistoryMember/history_gym_member.dart';
...
class HistoryKelasPage extends StatefulWidget {
  @override
  HistoryKelasPageState createState() => HistoryKelasPageState();
}

class HistoryKelasPageState extends State<HistoryKelasPage> {
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => HistoryGymPage()),
              );
            },
          ),
        ],
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => HistoryKelasPage()),
              );
            },
          ),
        ],
