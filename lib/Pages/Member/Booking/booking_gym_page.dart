...
import 'package:gofid_mobile_fix/Bloc/booking_gym/booking_gym_bloc.dart';
import 'package:gofid_mobile_fix/Bloc/booking_gym/form_booking_gym.dart';
import 'package:gofid_mobile_fix/Repository/repo_sesi.dart';
    ...
    return Padding(
      ...
      child: ElevatedButton(
          onPressed: () {
            ...
            var idMember = appBloc.state.member?.ID_MEMBER;
            context
                .read<BookingGymBloc>()
                .add(BookingSubmitted(idMember: idMember));
          },
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AppBloc, AppState>(builder: (context, appState) {
      return TextFormField(
        enabled: false,
        initialValue: appState.member!.ID_MEMBER,
        decoration: const InputDecoration(
            labelText: 'ID MEMBER', icon: Icon(Icons.card_membership)),
      );
    });
  }
}
        ...
        onTap: () async {
          ...
          if (pickedDate != null) {
            ...
            setState(() {
              ...
              context
                  .read<BookingGymBloc>()
                  .add(DateChanged(date: formattedDate));
            });
          } else {
                ...
                children: [
                  ...
                  Expanded(
                    child: DropdownButton(
                      items: generateItems(daftarSesi),
                      value: selectedSesi,
                      onChanged: (item) {
                        setState(() {
                          selectedSesi = item;
                          context
                              .read<BookingGymBloc>()
                              .add(SesiChanged(sesi: selectedSesi?.idSesi));
                        });
                      },
